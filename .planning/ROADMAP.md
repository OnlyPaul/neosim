...
- [x] 00-03-sweep-canvas-and-prototype-route-PLAN.md — DPR-aware sweepCanvas.ts (no cap) + Float32Array ring buffer + /prototype route with FPS overlay (WAVE-01, WAVE-04, WAVE-05) [SUMMARY](./phases/00-waveform-prototype/00-03-SUMMARY.md)
